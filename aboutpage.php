    ...
    <div class="row">
        <div class="">
            <div class="main-timeline-linking">
            	...
            	<div class="col-12 col-lg-6 col-md-6 col-sm-12 partenershwroom">
                <div class="timeline">
                    <a href="" class="timeline-content">
                       
                        <h3 class="title">Creative Family Building</h3>
                        <p class="description justify">
                            We believe that everyone has the right to become a parent. Whether you are just beginning your journey, have had previous fertility treatment, or have been told by other doctors that you are out of options, we will work with you to help you realize your dream of building a family.
...
<div class="col-lg-6 col-md-6 col-sm-12 partenershwroom">
                <div class="timeline">
                    <a href="" class="timeline-content">
                       
                        <h3 class="title">Cutting Edge Technology</h3>
                        <p class="description justify">
                            Advanced medical education and research are an important foundation for the services we provide, as the latest treatment methods and technology means better treatment options for you, We always strive to be at the forefront of medical advances and techniques. <!-- so that we can offer the most comprehensive and technologically innovative fertility care available. -->
                        </p>
                ...
                <div class="timeline">
                    <a href="" class="timeline-content">
                        ...
                        <h3 class="title">Affordable Fertility</h3>
                        <p class="description justify">
                            In addition to accepting many insurance providers, we have financial strategies to help make your journey to parenthood more affordable, including self-pay discounts, medication and treatment discount programs. Our team of specialists will help you navigate the options that are available to you.<br><br>
                            Nothing gives us greater joy than helping couple become parents. We welcome the opportunity to discuss your individual situation and your future family planning goals.  We invite you to contact us directly to learn more about how we can help you achieve your miracle of family.
                        </p>
                        <!-- <div class="timeline-icon"><i class="fa fa-rocket"></i></div> -->
                    </a>
                </div>
    ...
    <!--            	<div class="col-12 col-lg-6 col-md-6 col-sm-12">
                <div class="timeline">
                    <a href="#" class="timeline-content">
                        ...
                        <p class="description justify">
                            We understand that the journey towards parenthood can be a transformative experience that can profoundly affect you emotionally as well as physically. Therefore, we offer many different types of support to care for you on all levels.<br>
